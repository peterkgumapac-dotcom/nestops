              ...
              myJobs.length === 0 ? (
                ...
                <>
                  ...
                  {myJobs.map((job, idx) => {
                    ...
                    return (
                      <div key={job.id} style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 16, padding: '16px', marginBottom: 12 }}>
                        ...
                        {prefs?.toggles.pteStatus && pteInfo && job.pteStatus !== 'not_required' && (
                        ...
                        {prefs?.toggles.routingHint && isFirst && (
                          <div style={{ fontSize: 12, color: '#34d399', marginBottom: 4 }}>
                            📍 Go here first
                          </div>
                        )}

                        {prefs?.toggles.jobLocation && prop?.city && (
