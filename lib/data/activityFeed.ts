...
export const FEED_ITEMS: FeedItem[] = [
  ...
  { id: 'f4', type: 'completed',   actor: 'Anna Hansen', action: 'marked task complete',   property: 'Sunset Villa',   detail: 'Cleaning',                time: '2 min ago',        color: '#10b981' },
  { id: 'f5', type: 'guest_issue', actor: 'Lars Eriksen',action: 'logged guest issue',     property: 'Harbor Studio',  detail: 'Noise complaint',         time: '14 min ago',       color: '#ef4444' },
  { id: 'f6', type: 'field_report',actor: 'Sofia Berg',  action: 'submitted field report', property: 'Ocean View Apt', detail: 'Broken window latch',     time: '31 min ago',       color: '#d97706' },
  { id: 'f7', type: 'approved',    actor: 'Operator',    action: 'approved refund',        property: 'Downtown Loft',  detail: '750 NOK',                 time: '1h ago',           color: '#6366f1' },
  { id: 'f8', type: 'clocked_in',  actor: 'Magnus Dahl', action: 'clocked in',             property: 'Staff portal',   time: '2h ago',                   color: '#7c3aed' },
]
