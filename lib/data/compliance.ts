...
export const COMPLIANCE_DOCS: ComplianceDocument[] = [
  { id: 'cd1', category: 'Fire Safety Certificate', propertyId: 'p1', issuer: 'Oslo Brannvesen', issuedDate: '2024-01-15', expiryDate: '2026-01-15', status: 'valid', notes: 'Annual inspection passed' },
  ...
  { id: 'cd5', category: 'Electrical Inspection', propertyId: 'p1', issuer: 'Nelfo Certified', issuedDate: '2023-05-20', expiryDate: '2025-05-20', status: 'expired' },
  ...
  { id: 'cd10', category: 'Short-Term Rental License', propertyId: 'p2', issuer: 'Bergen Kommune', issuedDate: '2023-06-15', expiryDate: '2025-06-15', status: 'expiring' },
  ...
  { id: 'cd13', category: 'Building Insurance', propertyId: 'p1', issuer: 'Gjensidige', issuedDate: '2025-01-01', expiryDate: '2026-01-01', status: 'valid' },
  { id: 'cd14', category: 'Building Insurance', propertyId: 'p2', issuer: 'Tryg', issuedDate: '2024-04-01', expiryDate: '2026-04-01', status: 'valid' },
