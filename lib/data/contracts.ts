...
export const STAFF_CONTRACTS: StaffContract[] = [
  ...
  { staffId: 's3', staffName: 'Bjorn Larsen',   employmentType: 'part_time',  startDate: '2025-01-10', hourlyRate: 310, weeklyHours: 24, noticePeriodDays: 14, benefits: ['Pro-rata leave', '10 days sick pay', 'Tools provided'], status: 'active' },
