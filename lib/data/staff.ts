...
export const JOBS: Job[] = [
  ...
  },
  {
    ...
    type: 'intake', status: 'done', priority: 'medium',
  ...
  },
  {
    ...
    propertyId: 'p1', propertyName: 'Sunset Villa',
    type: 'guest_services', status: 'done', priority: 'medium',
  ...
  },
  {
    ...
    propertyId: 'p4', propertyName: 'Downtown Loft',
    type: 'delivery', status: 'done', priority: 'medium',
    dueTime: '14:00', urgencyLabel: 'Scheduled',
    pteRequired: true, pteStatus: 'granted',
...
export const STAFF_MEMBERS: StaffMember[] = [
  { id: 's1', name: 'Johan Larsson',  initials: 'JL', role: 'Senior Cleaner',            assignedPropertyIds: ['p1', 'p3', 'p5'],             status: 'active', jobIds: ['j1'],              hourlyRate: 285 },
  ...
  { id: 's5', name: 'Maria Solberg',  initials: 'MS', role: 'Cleaner',   assignedPropertyIds: ['p2', 'p3'],         status: 'active', jobIds: ['j4'],          hourlyRate: 275 },
  { id: 's6', name: 'Ivan Petersen',  initials: 'IP', role: 'Cleaner',   assignedPropertyIds: ['p4', 'p5'],         status: 'active', jobIds: ['j5'],          hourlyRate: 275 },
]
